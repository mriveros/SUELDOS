...
<html>
    ...
    <body>
        ...
        <div class='clearfix'></div>
                    ...
                    <div id="twitter">
                 		<form autocomplete="off" action="clases/ClsLineaDetalle.php?nuevo=1" method="post"> 
							...
							<label for="txtLinea">Linea:</label> 
                                                        <select name="txtLinea"  required>
                                                            ...
                                                            conexionlocal();
                                                            $query = "Select lin_cod ,lin_des from linea";
                                                        ...
                                                        <div class='message' id='nameDiv'> Ingrese linea </div>
                                                        <div class='clearfix'></div>
                                                        <div id='name' class='outerDiv'>
             ...
             <?php 
                    ...
                    if ($row = pg_fetch_array($result)){ 
                       ...
                       echo "<table style='margin: 6 auto;' heigth=100% width=80% bgcolor='white' border='5' bordercolor='black' cellspacing='3' cellpadding='3'> \n"; 
                         echo " <caption>Lineas Funcionarios (Presione Ctrl+F para buscar)</caption>";
                       echo "<th>Línea</th><th>Código Funcionario</th><th>Linea</th><th>CI Nº</th><th>Nombre</th><th>Apellido</th><th>Fecha Categoría</th> \n"; 
                       do {
                          echo "<tr><td>".$row["lineas"]."</td><td>".$row["fun_cod"]."</td><td>".$row["lin_des"]."</td><td>".$row["fun_ci"]."</td><td>".$row["fun_nom"]."</td><td>".$row["fun_ape"]."</td><td>".$row["lin_fec"]."</td></tr> \n"; 
